...
<div class="list-group list-group-light mb-4">
    <a href="{{ route('notice.view') }}" class="list-group-item list-group-item-action px-3 border-0">
        <i class="bi bi-megaphone-fill fa-lg text-primary me-3"></i> Official Announcements</a>

    <a href="{{ route('routines') }}" class="list-group-item list-group-item-action px-3 border-0">
        <i class="fas fa-calendar-alt fa-lg text-info me-3"></i> Lecture Schedules</a>

    <a href="{{ route('videos') }}" class="list-group-item list-group-item-action px-3 border-0">
        <i class="fas fa-video fa-lg text-danger me-3"></i> Recorded Lectures</a>

    <a href="{{ route('teacher_student_info') }}" class="list-group-item list-group-item-action px-3 border-0">
        <i class="fas fa-chalkboard-teacher fa-lg text-success me-3"></i>Faculty info</a>

    <a href="{{ route('teacher_student_info') }}" class="list-group-item list-group-item-action px-3 border-0">
        <i class="fas fa-user-friends fa-lg text-warning me-3"></i> Student info</a>
</div>
...
<div class="card text-start">
    <div class="card-body">
        ...
        <p class="card-text small text-muted mt-2">Let admitted in The Northcap University by completing some simple
            steps! </p>
