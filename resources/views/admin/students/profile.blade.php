                            ...
                            <div class="active tab-pane" id="information">
                                ...
                                <div class="card my-4">
                                    <div class="card-header attachment-block px-3 py-2 bg-gray-dark">
                                        <b>Exam records: CSE Department</b>
                                    </div>
                                ...
                                <div class="card my-4">
                                    <div class="card-header attachment-block px-3 py-2  bg-gray-dark">
                                        <b>Exam records: ECE Department</b>
                                    </div>
                                    <div class="card-body table-responsive p-0">
                                        <table class="table table-bordered table-striped examTable">
                                            <thead>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="c_class" class="form-control">
                                                ...
                                                <option value="HSC_Examinee"
                                                    @if ($item->c_class == 'HSC_Examinee') selected @endif>GATE Examinee
                                                </option>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="ssc_board" class="form-control">
                                                <option value="CBSE" @if ($item->ssc_board == 'CBSE') selected @endif>
                                                    CBSE</option>
                                                <option value="ICSE" @if ($item->ssc_board == 'ICSE') selected @endif>
                                                    ICSE</option>
                                                <option value="NIOS"
                                                    @if ($item->ssc_board == 'NIOS') selected @endif>NIOS</option>
