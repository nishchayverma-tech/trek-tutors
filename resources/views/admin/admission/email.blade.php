    ...
    <div class="row d-flex justify-content-center">
        <div class="card col-12 col-lg-5 col-md-7">
            <div class="card-body">
                ...
                <br> Hi, {{ $name }}
                <p class="text-success" style="color: #198754; font-size:16px"> Your admission of Northcap University has been <b>confirmed</b>.
                </p>
                <br>
                ...
                <div class="text-center">
                    Visit NCU to get more information- <br>
