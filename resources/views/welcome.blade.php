        ...
        <div class="container bg-light col-lg-9">
            ...
            <div class="d-md-flex justify-content-between">
                ...
                <div class="d-flex align-items-center py-2">
                    ...
                    <div class="ms-4">
                    <h1 class="text-purple mt-3 fw-bold mb-0" style="font-family: 'Poppins', sans-serif;">TREK TUTORS</h1>
                ...
                <div class="col-md-6">
                    <div class="card px-4 py-3 rounded-8 shadow-lg">
                        ...
                        <h2><strong>Login</strong></h2>
                            ...
                            <p>Doesn't have an account? <a class="btn btn-primary ms-2" href="{{ route('register') }}"><i class="fas fa-user-plus"></i> <u>Sign Up</u></a>
</p>
                        </div>
                        <div class="card-body">
        ...
        <div class="container">
            ...
            <div class="d-md-flex justify-content-center small mt-3">
                <div class="text-muted">&copy;
                    ...
                    </script>. Developed and supported by <a href=""
                        target="blank">Nishchay Verma | Vishal Jain</a>
                </div>
                <div class="ms-1">
                    &middot;
